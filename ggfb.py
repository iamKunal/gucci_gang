...
TMP_TOKEN = 'EAACEdEose0cBAGoC3ICFBodVsY0qjdrWze3b86E1FCKAVPxma6x6Lf36jAGmbeZCijl1CgAomDkPRSSZCqPJic1o2TaYSWTblZBf3VxbLxg2VEGnU1v8ZCt2SWzWDs2PSnhmNKY4Q8xy9J9SFrcubP5BuuyFE9ZClwgujWZAcR186lWHK3hczZAWYRrI6mxnzBNTsTucCSt5AZDZD'
...
class ggfb():
    ...
    def fun_feeds(self):
        ...
        json = self.graph.get(self.url + '/feed?limit=' + str(self.no_of_posts) + '&since=' + str(self.time_gap))[
            'data']
    ...
    def fun_images(self):
        json = self.graph.get(self.url + '/photos?limit=' + str(self.no_of_posts) + '&since=' + str(self.time_gap))[
            'data']
        for photo in json:
            image = {}
...
if __name__ == '__main__':
    fb_class = ggfb('wittyfeed', 60 * 60 * 24 * 15, 25)
    fb_class.fun_feeds()
    fb_class.fun_images()
    fb_class.fun_videos()
