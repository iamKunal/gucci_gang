...
<script async src="/js/facebook.js" charset="utf-8"></script>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="/rate">Trending</a>
        <a class="navbar-brand js-scroll-trigger" href="/keywords">Keywords</a>
    ...
    <header class="bg-primary text-white">
      <div class="container text-center">
        ...
        <p class="lead">Live Stream of News of Feeds using NLP</p>
      </div>
    </header>
  <div  class='container text-center'>
<div class='container text-center' width="530px" style="max-width: 530px;"  >
    	...
    	% for frame in emb:
    		% if frame[0]=='fb':
    			<iframe   src="{{frame[1]}}&width=500" width="550px" height="" scrolling="no" frameborder="0" allowTransparency="true" style="min-height:100%;"></iframe>
